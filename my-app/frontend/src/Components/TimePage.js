...
function TimePage() {
  const {user, handleSignout, handleSignIn, setIsSignedIn} = useContext(Context); //This is called destructuring an object. Assigns a variable of the same name the corresponding data in the object
