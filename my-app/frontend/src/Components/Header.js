...
function Header() {
    ...
    const [decision, setDecision] = useState("New Order")
    ...
    return (
        <header className='header'>
            ...
            <div id={decision === "New Order" ? "headerToHome" : "headerToTabs"} className="nav-bar">
